...
# Ford Blue/Green App - Installer Script
# This script deploys the Ford app with Instana monitoring configured via Kubernetes secrets

echo "=== Ford Blue/Green App Installer ==="
echo ""

# Configuration
NAMESPACE="ford-shop-dev"
ARGOCD_NAMESPACE="argocd-namespace"
APP_NAME="ford-bluegreen-app"
...
kubectl create secret generic backend-ford-instana-secret \
...
kubectl create secret generic frontend-ford-instana-secret \
...
echo ""
echo "Ford Blue/Green App has been deployed!"
echo ""
...
echo "  - backend-ford-instana-secret"
echo "  - frontend-ford-instana-secret"
echo ""
