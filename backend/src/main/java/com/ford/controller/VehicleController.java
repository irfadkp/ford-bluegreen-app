...
import com.ford.service.ErrorGeneratorService;
import com.ford.service.LogGeneratorService;
import com.ford.service.ExternalApiService;
...
public class VehicleController {
    ...
    public ResponseEntity<?> getAllVehicles() {
        ...
        List<Map<String, Object>> vehicles = Arrays.asList(
            ...
            createVehicle("Mustang", "Sports", 55000, "Red"),
            createVehicle("Explorer", "SUV", 48000, "Black"),
            createVehicle("Bronco", "SUV", 52000, "Orange"),
